...
method CReplicaNextProcessRequest(
...

  {
	...
	method CReplicaNextProcessAppStateSupply(
		s : CReplica ,
		received_packet : CPacket) returns (s':CReplica, sequential_sent_packets:OutboundPackets, replicaChanged:bool, reply_cache_mutable:MutableMap<EndPoint, CReply>)
		requires CReplicaIsValid(s)
		requires CPacketIsValid(received_packet)
    ...
    ensures CReplicaIsValid(s') && OutboundPacketsIsValid(sequential_sent_packets) && LReplicaNextProcessAppStateSupply(AbstractifyCReplicaToLReplica(s), AbstractifyCReplicaToLReplica(s'), AbstractifyCPacketToRslPacket(received_packet), AbstractifyOutboundCPacketsToSeqOfRslPackets(sequential_sent_packets))
    ...
    ensures Replica_Next_Process_AppStateSupply_Postconditions(
         ...
         received_packet, sequential_sent_packets)
  {
    ...
    reply_cache_mutable := empty_Mutable_Map;
		...
		{ 
			// (
      var e, reply_cache_mutable := CExecutorProcessAppStateSupply(s.executor, received_packet);
      ...
      // assert fresh(reply_cache_mutable);
        ...
        assert s'.executor.reply_cache == MutableMap.MapOf(reply_cache_mutable);
				sequential_sent_packets := OutboundPacket(None());
        replicaChanged := true;
        assert replicaChanged ==> fresh(reply_cache_mutable);
        assert replicaChanged ==> s'.executor.reply_cache == MutableMap.MapOf(reply_cache_mutable);
        assert !replicaChanged ==> s' == s;
			// )
    }
		else 
    {
    ...
    lemma_CReplicaNextProcessAppStateSupply1(s,received_packet,s',sequential_sent_packets,replicaChanged,reply_cache_mutable);
    assert  replicaChanged ==> fresh(reply_cache_mutable);
    assert  replicaChanged ==> s'.executor.reply_cache == MutableMap.MapOf(reply_cache_mutable);
    assert  !replicaChanged ==> s' == s;
  ...
  lemma {:axiom} lemma_CReplicaNextProcessAppStateSupply1(s : CReplica ,
		received_packet : CPacket, s':CReplica, sequential_sent_packets:OutboundPackets, replicaChanged:bool, reply_cache_mutable:MutableMap<EndPoint, CReply>)
    ensures  replicaChanged ==> fresh(reply_cache_mutable)
    ensures  replicaChanged ==> s'.executor.reply_cache == MutableMap.MapOf(reply_cache_mutable)
    ensures  !replicaChanged ==> s' == s
	
  method CReplicaNextProcessAppStateRequest(
		s : CReplica ,
		received_packet : CPacket,
    reply_cache_mutable:MutableMap<EndPoint, CReply>) returns (s':CReplica, sequential_sent_packets:OutboundPackets)
		requires CReplicaIsValid(s)
		requires CPacketIsValid(received_packet)
    ...
    ensures CReplicaIsValid(s') && OutboundPacketsIsValid(sequential_sent_packets) && LReplicaNextProcessAppStateRequest(AbstractifyCReplicaToLReplica(s), AbstractifyCReplicaToLReplica(s'), AbstractifyCPacketToRslPacket(received_packet), AbstractifyOutboundCPacketsToSeqOfRslPackets(sequential_sent_packets))
    ...
    ensures Replica_Next_Process_AppStateRequest_Postconditions(
      (AbstractifyCReplicaToLReplica(s)), s', received_packet, sequential_sent_packets)
  {
    // var (s', sequential_sent_packets) :=
		var e, p := CExecutorProcessAppStateRequest(s.executor, received_packet, reply_cache_mutable);
			s' := s.(
				executor := e
			); 
        ...
        (AbstractifyCReplicaToLReplica(s)), s', clock, sequential_sent_packets)
  {
	...
	method CReplicaNextReadClockCheckForViewTimeout(
		s : CReplica ,
		clock : CClockReading,
    cur_req_set:MutableSet<CRequestHeader>, prev_req_set:MutableSet<CRequestHeader>) returns (s':CReplica, sequential_sent_packets:OutboundPackets)
		requires CReplicaIsValid(s)
    ...
    ensures CReplicaIsValid(s') && OutboundPacketsIsValid(sequential_sent_packets) && LReplicaNextReadClockCheckForViewTimeout(AbstractifyCReplicaToLReplica(s), AbstractifyCReplicaToLReplica(s'), AbstractifyCClockReadingToClockReading(clock), AbstractifyOutboundCPacketsToSeqOfRslPackets(sequential_sent_packets))
    ...
    ensures Replica_Next_ReadClock_CheckForViewTimeout_Postconditions(
      (AbstractifyCReplicaToLReplica(s)), s', clock, sequential_sent_packets) 
  {
    var p := CProposerCheckForViewTimeout(s.proposer, clock.t, cur_req_set, prev_req_set);
    // var (s', sequential_sent_packets) := 
		// (
			s' := s.(
				proposer := p
	...
	method CReplicaNextReadClockCheckForQuorumOfViewSuspicions(
		s : CReplica ,
		clock : CClockReading,
    cur_req_set:MutableSet<CRequestHeader>, prev_req_set:MutableSet<CRequestHeader>) returns (s':CReplica, sequential_sent_packets:OutboundPackets)
		requires CReplicaIsValid(s)
    ...
    ensures Replica_Next_ReadClock_CheckForQuorumOfViewSuspicions_Postconditions(
        (AbstractifyCReplicaToLReplica(s)), s', clock, sequential_sent_packets)
                                                                                
  {
    var p := CProposerCheckForQuorumOfViewSuspicions(s.proposer, clock.t, cur_req_set, prev_req_set);
    // var (s', sequential_sent_packets) :=
		// (
			s' := s.(
				proposer := p
