...
module Common__NodeIdentity_i {
  ...
  function AbstractifyEndPointsToNodeIdentitiesSet(endPoints:set<EndPoint>) : set<NodeIdentity>
    ...
    // ensures |AbstractifyEndPointsToNodeIdentitiesSet(endPoints)| == |endPoints|
  {
    var ss := (set s | s in endPoints :: AbstractifyEndPointToNodeIdentity(s));
    ss
  }
  ...
  function{:opaque} AbstractifyNodeIdentityToEndPoint(id:NodeIdentity) : EndPoint
